...
// 1. Buat function userRegistered
function userRegistered(user){
    ...
    for(let i = 0; i < user.length; i++){
        // 5. buat filter untuk age dibawah 30 dan registered sesudah tahun 2018
        if(user[i].age < 30 && user[i].registered > "2018"){
...
console.log(userRegistered(users))
console.log(`Jumlah user umur dibawah 30 dan registered sesudah tahun 2018 ada ${userRegistered(users).length}`)